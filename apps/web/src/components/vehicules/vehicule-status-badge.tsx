...
// Active/inactive vehicle badge — outline style aligned with the usager,
// circuit and chauffeur status badges (transparent bg, thin hued border, dot).
const STYLES = {
  active: {
    dot: "bg-emerald-500",
    className:
...
export function VehiculeStatusBadge({ isActive }: { isActive: boolean }) {
